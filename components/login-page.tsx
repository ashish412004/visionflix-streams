    ...
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center">
      ...
      >
        <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-8 shadow-2xl">
          ...
          >
            {isRegister ? "CREATE ACCOUNT" : "PLATFORM INITIATORS SERVICE"}
          </motion.h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              type="submit"
              className="w-full py-4 bg-gradient-to-r from-pink-500 via-purple-500 to-pink-500 text-white font-bold rounded-lg shadow-lg shadow-pink-500/25 hover:shadow-pink-500/40 transition-all duration-300 uppercase tracking-wider text-sm"
            >
          ...
          >
            <p className="text-center text-gray-300 text-sm font-medium">
              Trusted by <span className="text-pink-400 font-bold">5000+</span> Customers
            </p>
          </motion.div>
        </div>
      </motion.div>
