        ...
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="mb-8">
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 bg-white/5 border border-white/20 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-500/30 transition-all duration-300"
                maxLength={10}
              />
          ...
          <div className="text-center mb-8">
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              onClick={handleCheck}
              className="px-8 py-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold rounded-xl shadow-lg hover:from-purple-600 hover:to-pink-600 transition-all duration-300"
            >
              Check Status
            </motion.button>
          </div>
                  ...
                  {result.status === 'Active' && result.daysRemaining && (
                    <div className="space-y-2">
                      ...
                      <p className="text-white">
                        ...
                        <span className="text-purple-400 font-semibold ml-2">{result.originalPlan}</span>
                      </p>
                    </div>
                  )}
