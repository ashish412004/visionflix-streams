          ...
          <div className="grid lg:grid-cols-2 gap-10 items-start">
            ...
            >
              <p className="text-gray-300 text-lg leading-relaxed">
                <span className="text-pink-400 font-semibold">Initiators Services</span> is the most trusted third-party seller for digital subscriptions in India. We are committed to providing you with premium OTT platforms, software licenses, and VPN services at unbeatable prices.
              </p>
              ...
              <div className="flex flex-wrap gap-6 pt-4">
                <div className="text-center">
                  <p className="text-3xl font-bold bg-gradient-to-r from-pink-500 to-purple-500 bg-clip-text text-transparent">5000+</p>
                  <p className="text-gray-500 text-sm">Happy Customers</p>
                </div>
                <div className="text-center">
                  <p className="text-3xl font-bold bg-gradient-to-r from-pink-500 to-purple-500 bg-clip-text text-transparent">50+</p>
                  <p className="text-gray-500 text-sm">Digital Services</p>
                </div>
                <div className="text-center">
                  <p className="text-3xl font-bold bg-gradient-to-r from-pink-500 to-purple-500 bg-clip-text text-transparent">24/7</p>
            ...
            >
              {features.map((feature, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="group bg-white/5 hover:bg-white/10 border border-white/10 hover:border-purple-500/30 rounded-xl p-5 transition-all duration-300"
                >
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-pink-500/20 to-purple-500/20 border border-pink-500/30 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300">
