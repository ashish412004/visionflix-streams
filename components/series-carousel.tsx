    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <button
            onClick={() => scroll("left")}
            className="absolute left-0 top-1/2 -translate-y-1/2 z-20 w-10 h-10 bg-black/60 hover:bg-purple-600/80 backdrop-blur-sm rounded-full flex items-center justify-center border border-white/20 transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-purple-500/30"
          >
          ...
          <button
            ...
            className="absolute right-0 top-1/2 -translate-y-1/2 z-20 w-10 h-10 bg-black/60 hover:bg-purple-600/80 backdrop-blur-sm rounded-full flex items-center justify-center border border-white/20 transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-purple-500/30"
          >
          ...
          >
            {doubledContent.map((item, index) => (
              ...
              >
                ...
                {/* Hover Glow Effect */}
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 bg-gradient-to-t from-purple-600/30 via-transparent to-transparent pointer-events-none" />
                ...
                <div className="absolute inset-0 rounded-xl border-2 border-transparent group-hover:border-purple-400/70 group-hover:shadow-[0_0_10px_rgba(168,85,247,0.6)] transition-all duration-300 pointer-events-none" />
              </motion.div>
            ))}
          </div>
