        ...
        <>
          ...
          >
            ...
            <div className="flex items-center justify-between p-6 border-b border-white/10 shrink-0 bg-zinc-950/80 backdrop-blur-md">
              ...
              <button
                onClick={onClose}
                className="p-2 text-white hover:text-red-500 transition-colors rounded-lg hover:bg-white/5"
              >
                <X size={20} />
              </button>
            </div>
                  ...
                  <>
                    ...
                    <div className="space-y-4">
                      {items.map((item) => (
                        ...
                        >
                          <div className={`w-12 h-12 ${item.bgColor || 'bg-red-500'} rounded-xl flex flex-col items-center justify-center shrink-0`}>
            ...
            {items.length > 0 && (
              <div className="absolute bottom-0 left-0 right-0 p-4 bg-zinc-950/95 backdrop-blur-md border-t border-white/10">
                <div className="flex gap-2">
                  <button
                    onClick={onClose}
                    className="flex-1 py-3 bg-gradient-to-r from-red-600 to-red-500 hover:from-red-500 hover:to-red-400 text-white font-semibold rounded-xl flex items-center justify-center gap-2 shadow-lg shadow-red-900/20 transition-all hover:scale-[1.02] active:scale-[0.98] text-sm"
                  >
                    <ShoppingBag size={16} />
                    CONTINUE SHOPPING
                  </button>
