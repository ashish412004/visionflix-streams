  ...
  return (
    <section className="px-3 py-8 md:px-4 md:py-12 max-w-7xl mx-auto">
      <div className="text-center mb-8 md:mb-12">
        ...
        >
          <HelpCircle className="w-6 h-6 md:w-8 md:h-8 text-red-500" />
