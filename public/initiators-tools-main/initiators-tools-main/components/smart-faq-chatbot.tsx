...
export function SmartFAQChatbot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      text: "Hi! Welcome to VisionFlix Streams Services. How can I help you today?",
      isUser: false,
      timestamp: new Date()
    }
  ])
    ...
    <>
      ...
      <div className="fixed bottom-[100px] right-5 z-[10000]">
        ...
        <motion.button
          ...
          className="w-14 h-14 bg-gradient-to-r from-red-600 to-red-500 hover:from-red-700 hover:to-red-600 rounded-full flex items-center justify-center shadow-lg shadow-red-500/30 transition-colors relative z-10"
        ...
        <AnimatePresence>
          {isOpen && (
            ...
            <div className="backdrop-blur-xl bg-black/80 border border-white/20 rounded-2xl shadow-2xl overflow-hidden flex flex-col w-full h-full">
              {/* Header */}
              <div className="bg-gradient-to-r from-red-600 to-red-500 p-3 md:p-4 relative">
                <button
