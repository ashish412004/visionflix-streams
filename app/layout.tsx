...
export const metadata: Metadata = {
  title: 'Initiators Tools | Premium Digital Subscriptions',
    ...
    "itemListElement": products.map((product, index) => ({
      ...
      "item": {
        ...
        "offers": {
          ...
          "url": `https://initiators.shop/product/${product.id}`
        }
      }
    }))
  }
